...
- (nonnull instancetype)initWithIndex:(NSInteger)index title:(NSString * _Nonnull)title media:(StoryMedia * _Nonnull)media OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithIndex:(NSInteger)index title:(NSString * _Nonnull)title stories:(NSArray<Story *> * _Nonnull)stories OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithType:(enum StoryType)type url:(NSString * _Nonnull)url actionUrl:(NSString * _Nullable)actionUrl OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@optional
- (void)storylyLoaded:(StorylyView * _Nonnull)storylyView storyGroupList:(NSArray<StoryGroup *> * _Nonnull)storyGroupList;
- (void)storylyLoadFailed:(StorylyView * _Nonnull)storylyView errorMessage:(NSString * _Nonnull)errorMessage;
- (BOOL)storylyActionClicked:(StorylyView * _Nonnull)storylyView rootViewController:(UIViewController * _Nonnull)rootViewController story:(Story * _Nonnull)story SWIFT_WARN_UNUSED_RESULT;
- (void)storylyStoryPresented:(StorylyView * _Nonnull)storylyView;
- (void)storylyStoryDismissed:(StorylyView * _Nonnull)storylyView;
@end


SWIFT_PROTOCOL("_TtP7Storyly34StorylyDynamicSegmentationCallback_")
@protocol StorylyDynamicSegmentationCallback
- (BOOL)filterWithStorylyGroupItemSegments:(NSSet<NSString *> * _Nullable)storylyGroupItemSegments segments:(NSSet<NSString *> * _Nullable)segments SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP7Storyly19StorylyExternalView_")
@protocol StorylyExternalView
...
SWIFT_PROTOCOL("_TtP7Storyly27StorylyExternalViewListener_")
@protocol StorylyExternalViewListener
- (void)onLoad:(id <StorylyExternalView> _Nonnull)externalView;
@end
...
- (nonnull instancetype)initWithStorylyId:(NSString * _Nonnull)storylyId segmentation:(StorylySegmentation * _Nonnull)segmentation OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithSegments:(NSSet<NSString *> * _Nullable)segments;
- (nonnull instancetype)initWithSegments:(NSSet<NSString *> * _Nullable)segments isDynamicSegmentationEnabled:(BOOL)isDynamicSegmentationEnabled dynamicSegmentationCallback:(id <StorylyDynamicSegmentationCallback> _Nullable)dynamicSegmentationCallback OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, weak) id <StorylyExternalViewProvider> _Nullable storylyExternalViewProvider;
